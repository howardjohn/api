...
var file_networking_v1alpha3_sidecar_proto_rawDesc = []byte{
	...
	0x63, 0x61, 0x6c, 0x68, 0x6f, 0x73, 0x74, 0x22, 0x83, 0x02, 0x0a, 0x14, 0x49, 0x73, 0x74, 0x69,
	...
	0x75, 0x6c, 0x74, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x4a, 0x04, 0x08, 0x05, 0x10,
...
var file_networking_v1alpha3_sidecar_proto_goTypes = []interface{}{
	...
	(*Destination)(nil),             // 9: istio.networking.v1alpha3.Destination
}
var file_networking_v1alpha3_sidecar_proto_depIdxs = []int32{
	...
	8,  // 6: istio.networking.v1alpha3.IstioEgressListener.port:type_name -> istio.networking.v1alpha3.Port
	0,  // 7: istio.networking.v1alpha3.IstioEgressListener.capture_mode:type_name -> istio.networking.v1alpha3.CaptureMode
	7,  // 8: istio.networking.v1alpha3.WorkloadSelector.labels:type_name -> istio.networking.v1alpha3.WorkloadSelector.LabelsEntry
	1,  // 9: istio.networking.v1alpha3.OutboundTrafficPolicy.mode:type_name -> istio.networking.v1alpha3.OutboundTrafficPolicy.Mode
	9,  // 10: istio.networking.v1alpha3.OutboundTrafficPolicy.egress_proxy:type_name -> istio.networking.v1alpha3.Destination
