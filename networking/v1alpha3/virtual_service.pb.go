...
var file_networking_v1alpha3_virtual_service_proto_rawDesc = []byte{
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x73, 0x75, 0x62, 0x6e, 0x65, 0x74, 0x22, 0x63, 0x0a,
	...
	0x28, 0x09, 0x52, 0x09, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x12, 0x23, 0x0a,
	...
	0x64, 0x65, 0x22, 0x3d, 0x0a, 0x0b, 0x48, 0x54, 0x54, 0x50, 0x52, 0x65, 0x77, 0x72, 0x69, 0x74,
	...
	0x74, 0x63, 0x68, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x22, 0xdf, 0x01, 0x0a, 0x09, 0x48, 0x54, 0x54,
	0x50, 0x52, 0x65, 0x74, 0x72, 0x79, 0x12, 0x20, 0x0a, 0x08, 0x61, 0x74, 0x74, 0x65, 0x6d, 0x70,
	0x74, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x42, 0x04, 0xe2, 0x41, 0x01, 0x02, 0x52, 0x08,
	...
	0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73, 0x22, 0x91, 0x05, 0x0a, 0x12,
	...
	0x74, 0x52, 0x05, 0x61, 0x62, 0x6f, 0x72, 0x74, 0x1a, 0x8a, 0x02, 0x0a, 0x05, 0x44, 0x65, 0x6c,
	...
	0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x44, 0x65, 0x6c, 0x61, 0x79, 0x12, 0x42,
	...
	0x67, 0x65, 0x42, 0x11, 0x0a, 0x0f, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x64, 0x65, 0x6c, 0x61, 0x79,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x1a, 0xd7, 0x01, 0x0a, 0x05, 0x41, 0x62, 0x6f, 0x72, 0x74, 0x12,
	0x27, 0x0a, 0x0b, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x05, 0x42, 0x04, 0xe2, 0x41, 0x01, 0x02, 0x48, 0x00, 0x52, 0x0a, 0x68, 0x74,
...
var file_networking_v1alpha3_virtual_service_proto_goTypes = []interface{}{
	(*VirtualService)(nil),           // 0: istio.networking.v1alpha3.VirtualService
	(*Destination)(nil),              // 1: istio.networking.v1alpha3.Destination
	(*HTTPRoute)(nil),                // 2: istio.networking.v1alpha3.HTTPRoute
	(*Delegate)(nil),                 // 3: istio.networking.v1alpha3.Delegate
	(*Headers)(nil),                  // 4: istio.networking.v1alpha3.Headers
	(*TLSRoute)(nil),                 // 5: istio.networking.v1alpha3.TLSRoute
	(*TCPRoute)(nil),                 // 6: istio.networking.v1alpha3.TCPRoute
	(*HTTPMatchRequest)(nil),         // 7: istio.networking.v1alpha3.HTTPMatchRequest
	(*HTTPRouteDestination)(nil),     // 8: istio.networking.v1alpha3.HTTPRouteDestination
	(*RouteDestination)(nil),         // 9: istio.networking.v1alpha3.RouteDestination
	(*L4MatchAttributes)(nil),        // 10: istio.networking.v1alpha3.L4MatchAttributes
	(*TLSMatchAttributes)(nil),       // 11: istio.networking.v1alpha3.TLSMatchAttributes
	(*HTTPRedirect)(nil),             // 12: istio.networking.v1alpha3.HTTPRedirect
	(*HTTPRewrite)(nil),              // 13: istio.networking.v1alpha3.HTTPRewrite
	(*StringMatch)(nil),              // 14: istio.networking.v1alpha3.StringMatch
	(*HTTPRetry)(nil),                // 15: istio.networking.v1alpha3.HTTPRetry
	(*CorsPolicy)(nil),               // 16: istio.networking.v1alpha3.CorsPolicy
	(*HTTPFaultInjection)(nil),       // 17: istio.networking.v1alpha3.HTTPFaultInjection
	(*PortSelector)(nil),             // 18: istio.networking.v1alpha3.PortSelector
	(*Percent)(nil),                  // 19: istio.networking.v1alpha3.Percent
	(*Headers_HeaderOperations)(nil), // 20: istio.networking.v1alpha3.Headers.HeaderOperations
	nil,                              // 21: istio.networking.v1alpha3.Headers.HeaderOperations.SetEntry
	nil,                              // 22: istio.networking.v1alpha3.Headers.HeaderOperations.AddEntry
	nil,                              // 23: istio.networking.v1alpha3.HTTPMatchRequest.HeadersEntry
	nil,                              // 24: istio.networking.v1alpha3.HTTPMatchRequest.SourceLabelsEntry
	nil,                              // 25: istio.networking.v1alpha3.HTTPMatchRequest.QueryParamsEntry
	nil,                              // 26: istio.networking.v1alpha3.HTTPMatchRequest.WithoutHeadersEntry
	nil,                              // 27: istio.networking.v1alpha3.L4MatchAttributes.SourceLabelsEntry
	nil,                              // 28: istio.networking.v1alpha3.TLSMatchAttributes.SourceLabelsEntry
	(*HTTPFaultInjection_Delay)(nil), // 29: istio.networking.v1alpha3.HTTPFaultInjection.Delay
	(*HTTPFaultInjection_Abort)(nil), // 30: istio.networking.v1alpha3.HTTPFaultInjection.Abort
...
var file_networking_v1alpha3_virtual_service_proto_depIdxs = []int32{
	2,  // 0: istio.networking.v1alpha3.VirtualService.http:type_name -> istio.networking.v1alpha3.HTTPRoute
	5,  // 1: istio.networking.v1alpha3.VirtualService.tls:type_name -> istio.networking.v1alpha3.TLSRoute
	6,  // 2: istio.networking.v1alpha3.VirtualService.tcp:type_name -> istio.networking.v1alpha3.TCPRoute
	18, // 3: istio.networking.v1alpha3.Destination.port:type_name -> istio.networking.v1alpha3.PortSelector
	7,  // 4: istio.networking.v1alpha3.HTTPRoute.match:type_name -> istio.networking.v1alpha3.HTTPMatchRequest
	8,  // 5: istio.networking.v1alpha3.HTTPRoute.route:type_name -> istio.networking.v1alpha3.HTTPRouteDestination
	12, // 6: istio.networking.v1alpha3.HTTPRoute.redirect:type_name -> istio.networking.v1alpha3.HTTPRedirect
	3,  // 7: istio.networking.v1alpha3.HTTPRoute.delegate:type_name -> istio.networking.v1alpha3.Delegate
	13, // 8: istio.networking.v1alpha3.HTTPRoute.rewrite:type_name -> istio.networking.v1alpha3.HTTPRewrite
	31, // 9: istio.networking.v1alpha3.HTTPRoute.timeout:type_name -> google.protobuf.Duration
	15, // 10: istio.networking.v1alpha3.HTTPRoute.retries:type_name -> istio.networking.v1alpha3.HTTPRetry
	17, // 11: istio.networking.v1alpha3.HTTPRoute.fault:type_name -> istio.networking.v1alpha3.HTTPFaultInjection
	1,  // 12: istio.networking.v1alpha3.HTTPRoute.mirror:type_name -> istio.networking.v1alpha3.Destination
	32, // 13: istio.networking.v1alpha3.HTTPRoute.mirror_percent:type_name -> google.protobuf.UInt32Value
	19, // 14: istio.networking.v1alpha3.HTTPRoute.mirror_percentage:type_name -> istio.networking.v1alpha3.Percent
	16, // 15: istio.networking.v1alpha3.HTTPRoute.cors_policy:type_name -> istio.networking.v1alpha3.CorsPolicy
	4,  // 16: istio.networking.v1alpha3.HTTPRoute.headers:type_name -> istio.networking.v1alpha3.Headers
	20, // 17: istio.networking.v1alpha3.Headers.request:type_name -> istio.networking.v1alpha3.Headers.HeaderOperations
	20, // 18: istio.networking.v1alpha3.Headers.response:type_name -> istio.networking.v1alpha3.Headers.HeaderOperations
	11, // 19: istio.networking.v1alpha3.TLSRoute.match:type_name -> istio.networking.v1alpha3.TLSMatchAttributes
	9,  // 20: istio.networking.v1alpha3.TLSRoute.route:type_name -> istio.networking.v1alpha3.RouteDestination
	10, // 21: istio.networking.v1alpha3.TCPRoute.match:type_name -> istio.networking.v1alpha3.L4MatchAttributes
	9,  // 22: istio.networking.v1alpha3.TCPRoute.route:type_name -> istio.networking.v1alpha3.RouteDestination
	14, // 23: istio.networking.v1alpha3.HTTPMatchRequest.uri:type_name -> istio.networking.v1alpha3.StringMatch
	14, // 24: istio.networking.v1alpha3.HTTPMatchRequest.scheme:type_name -> istio.networking.v1alpha3.StringMatch
	14, // 25: istio.networking.v1alpha3.HTTPMatchRequest.method:type_name -> istio.networking.v1alpha3.StringMatch
	14, // 26: istio.networking.v1alpha3.HTTPMatchRequest.authority:type_name -> istio.networking.v1alpha3.StringMatch
	23, // 27: istio.networking.v1alpha3.HTTPMatchRequest.headers:type_name -> istio.networking.v1alpha3.HTTPMatchRequest.HeadersEntry
	24, // 28: istio.networking.v1alpha3.HTTPMatchRequest.source_labels:type_name -> istio.networking.v1alpha3.HTTPMatchRequest.SourceLabelsEntry
	25, // 29: istio.networking.v1alpha3.HTTPMatchRequest.query_params:type_name -> istio.networking.v1alpha3.HTTPMatchRequest.QueryParamsEntry
	26, // 30: istio.networking.v1alpha3.HTTPMatchRequest.without_headers:type_name -> istio.networking.v1alpha3.HTTPMatchRequest.WithoutHeadersEntry
	1,  // 31: istio.networking.v1alpha3.HTTPRouteDestination.destination:type_name -> istio.networking.v1alpha3.Destination
	4,  // 32: istio.networking.v1alpha3.HTTPRouteDestination.headers:type_name -> istio.networking.v1alpha3.Headers
	1,  // 33: istio.networking.v1alpha3.RouteDestination.destination:type_name -> istio.networking.v1alpha3.Destination
	27, // 34: istio.networking.v1alpha3.L4MatchAttributes.source_labels:type_name -> istio.networking.v1alpha3.L4MatchAttributes.SourceLabelsEntry
	28, // 35: istio.networking.v1alpha3.TLSMatchAttributes.source_labels:type_name -> istio.networking.v1alpha3.TLSMatchAttributes.SourceLabelsEntry
	31, // 36: istio.networking.v1alpha3.HTTPRetry.per_try_timeout:type_name -> google.protobuf.Duration
	33, // 37: istio.networking.v1alpha3.HTTPRetry.retry_remote_localities:type_name -> google.protobuf.BoolValue
	14, // 38: istio.networking.v1alpha3.CorsPolicy.allow_origins:type_name -> istio.networking.v1alpha3.StringMatch
	31, // 39: istio.networking.v1alpha3.CorsPolicy.max_age:type_name -> google.protobuf.Duration
	33, // 40: istio.networking.v1alpha3.CorsPolicy.allow_credentials:type_name -> google.protobuf.BoolValue
	29, // 41: istio.networking.v1alpha3.HTTPFaultInjection.delay:type_name -> istio.networking.v1alpha3.HTTPFaultInjection.Delay
	30, // 42: istio.networking.v1alpha3.HTTPFaultInjection.abort:type_name -> istio.networking.v1alpha3.HTTPFaultInjection.Abort
	21, // 43: istio.networking.v1alpha3.Headers.HeaderOperations.set:type_name -> istio.networking.v1alpha3.Headers.HeaderOperations.SetEntry
	22, // 44: istio.networking.v1alpha3.Headers.HeaderOperations.add:type_name -> istio.networking.v1alpha3.Headers.HeaderOperations.AddEntry
	14, // 45: istio.networking.v1alpha3.HTTPMatchRequest.HeadersEntry.value:type_name -> istio.networking.v1alpha3.StringMatch
	14, // 46: istio.networking.v1alpha3.HTTPMatchRequest.QueryParamsEntry.value:type_name -> istio.networking.v1alpha3.StringMatch
	14, // 47: istio.networking.v1alpha3.HTTPMatchRequest.WithoutHeadersEntry.value:type_name -> istio.networking.v1alpha3.StringMatch
	31, // 48: istio.networking.v1alpha3.HTTPFaultInjection.Delay.fixed_delay:type_name -> google.protobuf.Duration
	31, // 49: istio.networking.v1alpha3.HTTPFaultInjection.Delay.exponential_delay:type_name -> google.protobuf.Duration
	19, // 50: istio.networking.v1alpha3.HTTPFaultInjection.Delay.percentage:type_name -> istio.networking.v1alpha3.Percent
	19, // 51: istio.networking.v1alpha3.HTTPFaultInjection.Abort.percentage:type_name -> istio.networking.v1alpha3.Percent
